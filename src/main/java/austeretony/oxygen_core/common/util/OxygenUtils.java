...
public class OxygenUtils {
    ...
    public static TextFormatting formattingFromAmpCode(String code) {
        if(code.equals("&0"))return TextFormatting.BLACK;
        if(code.equals("&1"))return TextFormatting.DARK_BLUE;
        if(code.equals("&2"))return TextFormatting.DARK_GREEN;
        if(code.equals("&3"))return TextFormatting.DARK_AQUA;
        if(code.equals("&4"))return TextFormatting.DARK_RED;
        if(code.equals("&5"))return TextFormatting.DARK_PURPLE;
        if(code.equals("&6"))return TextFormatting.GOLD;
        if(code.equals("&7"))return TextFormatting.GRAY;
        if(code.equals("&8"))return TextFormatting.DARK_GRAY;
        if(code.equals("&9"))return TextFormatting.BLUE;
        if(code.equals("&a"))return TextFormatting.GREEN;
        if(code.equals("&b"))return TextFormatting.AQUA;
        if(code.equals("&c"))return TextFormatting.RED;
        if(code.equals("&d"))return TextFormatting.LIGHT_PURPLE;
        if(code.equals("&e"))return TextFormatting.YELLOW;
        if(code.equals("&f"))return TextFormatting.WHITE;
